...
class Board:
    def __init__(self):
        self.coins = []
        self.coins.append(coin(1,7,'black'))
        self.coins.append(coin(3,7,'black'))
        self.coins.append(coin(5,7,'black'))
        self.coins.append(coin(7,7,'black'))
        self.coins.append(coin(2,8,'black'))
        self.coins.append(coin(4,8,'black'))
        self.coins.append(coin(6,8,'black'))
        self.coins.append(coin(8,8,'black'))
        self.coins.append(coin(2,6,'black'))
        self.coins.append(coin(4,6,'black'))
        self.coins.append(coin(6,6,'black'))
        self.coins.append(coin(8,6,'black'))
